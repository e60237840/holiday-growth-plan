...
export function createDemoData(): AppData {
  return {
    ...
    tasks: [
      { id: "t1", user_id: "demo-user", series_id: null, title: "完成数学练习", description: "订正昨天的错题", category: "学习", task_date: today, start_time: "09:00", duration_minutes: 40, star_reward: 8, game_minutes_reward: 10, repeat_type: "不重复", weekdays: [], require_parent_approval: true, is_required: true, is_active: true, status: "已完成", completed_at: new Date().toISOString(), approved_at: new Date().toISOString(), reward_granted: true, parent_note: null },
      { id: "t2", user_id: "demo-user", series_id: null, title: "阅读《昆虫记》", description: "阅读 20 页并说说最有趣的发现", category: "阅读", task_date: today, start_time: "10:20", duration_minutes: 30, star_reward: 6, game_minutes_reward: 5, repeat_type: "不重复", weekdays: [], require_parent_approval: true, is_required: true, is_active: true, status: "待家长确认", completed_at: new Date().toISOString(), approved_at: null, reward_granted: false, parent_note: null },
      { id: "t3", user_id: "demo-user", series_id: null, title: "户外运动", description: "跳绳或骑车，自选一项", category: "运动", task_date: today, start_time: "16:30", duration_minutes: 45, star_reward: 8, game_minutes_reward: 10, repeat_type: "不重复", weekdays: [], require_parent_approval: true, is_required: false, is_active: true, status: "未开始", completed_at: null, approved_at: null, reward_granted: false, parent_note: null },
      { id: "t4", user_id: "demo-user", series_id: null, title: "整理书桌", description: "物品归位，桌面擦干净", category: "家务", task_date: today, start_time: "19:30", duration_minutes: 15, star_reward: 4, game_minutes_reward: 0, repeat_type: "不重复", weekdays: [], require_parent_approval: false, is_required: false, is_active: true, status: "未开始", completed_at: null, approved_at: null, reward_granted: false, parent_note: null },
    ],
    points: [
